...
bool LoginHandler::regis(int userType, QString userName, QString userRealName, QString userPassword) {
...
QString LoginHandler::getUserName() {
    return this->m_baseUser.userName;
}

QString LoginHandler::getRealName() {
    return this->m_baseUser.realName;
}

int LoginHandler::getLevelPassed() {
    return this->m_baseUser.levelPassed;
}

int LoginHandler::getExperience() {
    return this->m_baseUser.experience;
}
