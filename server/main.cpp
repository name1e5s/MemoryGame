...
int main() {
  ...
  cout << "Test::" << Word::Instance().nextWord(1).word << endl;
  cout << "Test::" << Word::Instance().nextWord(2).word << endl;
  cout << "Test::" << Word::Instance().nextWord(3).word << endl;

  cout << "Login::" << Login::Instance().getGamer("user", "test").second.uid
       << endl;
  //} catch (exception &e) {
  // cout << e.what() << endl;
  //}
