...
int main(int argc, char *argv[]) {
  ...
  if (Client::Instance().SocketClient::connect()) {
    UserTableModel userTableModel;
    userTableModel.setColumn(5);
    ...
    engine.rootContext()->setContextProperty("game_client",
                                             &Client::Instance());
    ...
    qmlRegisterType<UserTableModel>("com.name1e5s.game", 1, 0,
                                    "UserTableModel");
    qmlRegisterType<WordTableModel>("com.name1e5s.game", 1, 0,
                                    "WordTableModel");
