...
QString UserHandler::getUserName() const { return userName; }
...
QString UserHandler::getRealName() const { return realName; }
...
int UserHandler::getLevelPassed() const { return levelPassed; }
...
int UserHandler::getExperience() const { return experience; }
...
void UserHandler::updateUser() { UserDB::Instance().updateUser(this); }
